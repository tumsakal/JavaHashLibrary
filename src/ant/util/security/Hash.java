...
public class Hash {
    ...
    public static String computeBase64MD5(byte[] data) {
        ...
        return Base64.getEncoder().withoutPadding().encodeToString(md5);
    }
    ...
    public static String computeBase64SHA1(byte[] data) {
        ...
        return Base64.getEncoder().withoutPadding().encodeToString(sha1);
    }
    ...
    public static String computeBase64SHA256(byte[] data) {
        ...
        return Base64.getEncoder().withoutPadding().encodeToString(sha256);
    }
